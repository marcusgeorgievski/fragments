...
A fragment is defined as any piece of text (e.g., MIME type of `text/plain`, `text/markdown`, `text/html`, `text/csv`, etc.), JSON data (`application/json`), or an image in any of the following formats:
